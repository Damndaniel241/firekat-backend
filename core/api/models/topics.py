...
class Topic(models.Model):
    ...
    subject = models.ForeignKey(Subject,on_delete=models.SET_NULL,blank=True,null=True, related_name='subject_topics')
    author = models.ForeignKey(CustomUser,on_delete=models.SET_NULL,null=True, related_name="owned_topics")
    faculty = models.ForeignKey(Faculty, on_delete=models.SET_NULL, null=True, blank=True, related_name="faculty_topics")
